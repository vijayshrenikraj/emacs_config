...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (dumb-jump git-blamed git helm magit haskell-mode ctags-update smart-mode-line diff-hl textmate auto-complete robe rainbow-delimiters rainbow-mode aggressive-indent)))
 '(visible-bell t))
(custom-set-faces
